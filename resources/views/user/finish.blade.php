  ...
  <div class="max-w-4xl mx-auto flex flex-col items-center p-4">
    ...
    <div class="flex flex-col justify-center max-w-2xl">
      <h1 data-aos="zoom-in-up" data-aos-duration="500" class="text-4xl text-center font-bold text-softblack mb-10">
        Selamat!</h1>
      <h3 data-aos="zoom-in-up" data-aos-duration="500" class="text-softblack text-4xl text-center font-bold  mb-10">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed.</h1>
    </div>
